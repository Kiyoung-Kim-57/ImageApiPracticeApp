...
private struct ContainerListView: View {
    ...
    @State private var sheetImgModel: ImageDTO?
    var body: some View {
        VStack {
            ScrollView {
...
private struct ContainerView: View {
    ...
    @State private var imgData: ImageDTO
    @State private var image: UIImage?
    
    init(imageViewModel: ImageViewModel, imgData: ImageDTO, image: UIImage? = nil) {
...
extension ContainerView {
    ...
    func cacheDataOnDismiss(_ imgData: ImageDTO) {
